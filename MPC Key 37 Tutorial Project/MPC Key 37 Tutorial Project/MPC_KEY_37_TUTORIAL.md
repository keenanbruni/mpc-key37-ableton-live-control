...
- **A5**: switch the Q-Links between parameter slots 1–4 and 5–8. If this triggers sound from track 2 (Drift), check its MIDI input and monitoring.
...
### 4. Keyboard, editing, and transport 
